...
const jobs = [{
  ...
  responsibilities: [
    'Developed a search engine querying the database for the location of listings within user\'s preferred locations for buying the house using ReactJS/Redux and Ruby-on-Rails',
    'Automated several manual operations involved in buying a house: brought down the time taken to draft offers on any house from 45 minutes to 5 minutes and time to find the best price through comparable listing analysis',
    'Created a customised recommendation system to suggest listings to prospective buyers based on their search criteria',
    'Planned architecture for automated and scheduled migration of data from multiple listing service providers to a single source',
    'Created a feed at flyhomes.com based on the user\'s saved search on the lines of inbox zero'
  ]
}, {
  ...
  responsibilities: [
    'Handled tech behind Strawberry POS, the restaurant point of sale system in a three membered team',
